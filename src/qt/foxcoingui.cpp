...
FoxcoinGUI::FoxcoinGUI(QWidget *parent):
    QMainWindow(parent),
    clientModel(0),
    walletModel(0),
    ...
    rpcConsole(0)
{
    ...
    setWindowIcon(QIcon(":icons/foxcoin"));
#else
...
void FoxcoinGUI::createActions()
{
    ...
    aboutAction = new QAction(QIcon(":/icons/foxcoin"), tr("&About FoxCoin"), this);
    ...
    toggleHideAction = new QAction(QIcon(":/icons/foxcoin"), tr("Show/Hide &FoxCoin"), this);
    ...
    beginnerToFoxCoinAction = new QAction(QIcon(":/icons/foxcoin"), tr("&What is FoxCoin?"), this);
    ...
    miningTutorialAction = new QAction(QIcon(":/icons/mining_active"), tr("&How to dig FoxCoin"), this);
    miningTutorialAction->setToolTip(tr("A beginners guide to digging."));
...
void FoxcoinGUI::createToolBars()
{
...
void FoxcoinGUI::setClientModel(ClientModel *clientModel)
{
...
#ifndef Q_WS_MAC
            qApp->setWindowIcon(QIcon(":icons/foxcoin_testnet"));
            setWindowIcon(QIcon(":icons/foxcoin_testnet"));
#else
            MacDockIconHandler::instance()->setIcon(QIcon(":icons/foxcoin_testnet"));
#endif
            if(trayIcon)
            {
...
void FoxcoinGUI::setWalletModel(WalletModel *walletModel)
{
...
void FoxcoinGUI::createTrayIcon()
{
    QMenu *trayIconMenu;
#ifndef Q_WS_MAC
...
#ifndef Q_WS_MAC
void FoxcoinGUI::trayIconActivated(QSystemTrayIcon::ActivationReason reason)
{
...
void FoxcoinGUI::optionsClicked()
{
...
void FoxcoinGUI::beginnerClicked()
{
    BeginnerDialog dlg;
    dlg.setModel(clientModel);
    dlg.exec();
...
void FoxcoinGUI::miningTutClicked()
{
    miningTutDialog dlg;
    dlg.setModel(clientModel);
    dlg.exec();
...
void FoxcoinGUI::transactionTutClicked()
{
...
void FoxcoinGUI::protectionTutClicked()
{
...
void FoxcoinGUI::setNumConnections(int count)
{
    QString icon;
    switch(count)
    {
...
void FoxcoinGUI::setNumBlocks(int count, int nTotalBlocks)
{
    ...
    if(count < nTotalBlocks)
    {
        ...
        if (clientModel->getStatusBarWarnings() == "")
        {
            ...
            progressBar->setStyleSheet("QProgressBar::chunk {background: qlineargradient(x1: 0, y1: 0.5, x2: 1, y2: 0.5, stop: 0 orange, stop: 1 white); }");
            progressBar->update();
...
void FoxcoinGUI::setMining(bool mining, int hashrate)
{
    if (mining)
    {
...
void FoxcoinGUI::error(const QString &title, const QString &message, bool modal)
{
    // Report errors from network/worker thread
    if(modal)
    {
...
void FoxcoinGUI::changeEvent(QEvent *e)
{
...
void FoxcoinGUI::closeEvent(QCloseEvent *event)
{
    if(clientModel)
    {
#ifndef Q_WS_MAC // Ignored on Mac
...
void FoxcoinGUI::askFee(qint64 nFeeRequired, bool *payFee)
{
    QString strMessage =
        tr("This transaction is over the size limit.  You can still send it for a fee of %1, "
          "which goes to the tunnels that process your transaction and helps to support the network.  "
          "Do you want to pay the fee?").arg(
                FoxcoinUnits::formatWithUnit(FoxcoinUnits::FOX, nFeeRequired));
...
void FoxcoinGUI::incomingTransaction(const QModelIndex & parent, int start, int end)
{
        ...
        notificator->notify(Notificator::Information,
                            (amount)<0 ? tr("Sent transaction") :
                              ...
                              tr("Date: %1\n"
                                 ...
                                 "Address: %4\n")
                              .arg(date)
                              .arg(FoxcoinUnits::formatWithUnit(walletModel->getOptionsModel()->getDisplayUnit(), amount, true))
                              .arg(type)
                              .arg(address), icon);
    }
}

void FoxcoinGUI::gotoOverviewPage()
{
...
void FoxcoinGUI::gotoMiningPage()
{
...
void FoxcoinGUI::gotoStatisticsPage()
{
...
void FoxcoinGUI::gotoAcreBrowser()
{
...
void FoxcoinGUI::gotoHistoryPage()
{
...
void FoxcoinGUI::gotoAddressBookPage()
{
...
void FoxcoinGUI::gotoReceiveCoinsPage()
{
...
void FoxcoinGUI::gotoSendCoinsPage()
{
...
void FoxcoinGUI::gotoSignMessageTab(QString addr)
{
#ifdef FIRST_CLASS_MESSAGING
...
void FoxcoinGUI::gotoVerifyMessageTab(QString addr)
{
#ifdef FIRST_CLASS_MESSAGING
    firstClassMessagingAction->setChecked(true);
    centralWidget->setCurrentWidget(signVerifyMessageDialog);
...
void FoxcoinGUI::dragEnterEvent(QDragEnterEvent *event)
{
    // Accept only URIs
...
void FoxcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
...
void FoxcoinGUI::handleURI(QString strURI)
{
    // URI has to be valid
...
void FoxcoinGUI::setEncryptionStatus(int status)
{
    switch(status)
    {
...
void FoxcoinGUI::encryptWallet(bool status)
{
    if(!walletModel)
        return;
...
void FoxcoinGUI::changePassphrase()
{
...
void FoxcoinGUI::showNormalIfMinimized(bool fToggleHidden)
{
